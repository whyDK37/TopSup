...
def ocr_img(image):
    ...
    question_im = image.crop((120, 500, 1330, 700))
    choices_im = image.crop((125, 730, 1330, 1500))
    # 边缘增强滤波,不一定适用
    ...
    question_im.save("d:\\q.png")
    choices_im.save("d:\\l.png")
    # 把图片变成二值图像
    ...
    # win环境
    # tesseract 路径
    pytesseract.pytesseract.tesseract_cmd = 'D:\\Applications\\Tesseract-OCR\\tesseract'
    # 语言包目录和参数
    tessdata_dir_config = '--tessdata-dir "D:\\Applications\\Tesseract-OCR\\tessdata" --psm 6'
